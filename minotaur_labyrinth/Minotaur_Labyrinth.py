...
import pygame, minotaur_labyrinth.labyrinthSprites, random
        ...
        for col in range(len(maze_arrangement[row])):
            if maze_arrangement[row][col] == 1: 
                if (row == 7 and col == 6) or (row == 6 and col == 8) or \
                   (row == 8 and col == 9):
                    stone = minotaur_labyrinth.labyrinthSprites.Stone(random.randint(0,3), row*50, col*50, True)
                    maze_wall.add(stone)
                else:
                    stone = minotaur_labyrinth.labyrinthSprites.Stone(random.randint(0,3), row*50, col*50, False)
                    maze_wall.add(stone)                    
    ...
    for gear_item in range(4):
        ...
        while not valid_place:
            ...
            # Ensuring the gear pieces only spawn on a valid pathway block
                ...
                powerup = minotaur_labyrinth.labyrinthSprites.GearPieces(gear_item, row*50, col*50)
                gear_powerups.add(powerup)
                valid_place = True                

def game_instructions(screen):
    # DISPLAY ==================================================================
    background = pygame.image.load("./minotaur_labyrinth/MiscImages/Introduction_Screen.jpg")
    screen.blit(background, (0, 0))    
    
    # ENTITIES ================================================================= 
    start_game_sound = pygame.mixer.Sound("./minotaur_labyrinth/Sounds/metal_gong.wav")
...
def game(screen):
    ...
    # DISPLAY ==================================================================
    background = pygame.image.load("./minotaur_labyrinth/MiscImages/background.jpg")
    ...
    pygame.mixer.music.load("./minotaur_labyrinth/Sounds/eerie_music.mp3")
    pygame.mixer.music.set_volume(0.4)
    pygame.mixer.music.play(-1) 
    
    # The Minotaur's growl when his distance is "far" from the player
    far_minotaur_growl = pygame.mixer.Sound("./minotaur_labyrinth/Sounds/monster_snarl.wav")
    far_minotaur_growl.set_volume(0.1)

    # Light Click
    click = pygame.mixer.Sound("./minotaur_labyrinth/Sounds/click.wav")
    click.set_volume(0.5)
    shock = pygame.mixer.Sound("./minotaur_labyrinth/Sounds/shock.wav")
    shock.set_volume(0.5)
    # The Minotaur's growl when his distance is "somewhat far" from the player
    med_minotaur_growl = pygame.mixer.Sound("./minotaur_labyrinth/Sounds/monster_snarl.wav")
    med_minotaur_growl.set_volume(0.25) 
    
    # The Minotaur's growl when his distance is "close" to the player
    close_minotaur_growl = pygame.mixer.Sound("./minotaur_labyrinth/Sounds/monster_snarl.wav")
    close_minotaur_growl.set_volume(0.5)       
    
    equip_gear_sound = pygame.mixer.Sound("./minotaur_labyrinth/Sounds/sword_clash.wav")
    equip_gear_sound.set_volume(0.7)
    
    minotaur_death_sound = pygame.mixer.Sound("./minotaur_labyrinth/Sounds/minotaur_death.wav")
    minotaur_death_sound.set_volume(1.0)
    
    minotaur_spawn_sound = pygame.mixer.Sound("./minotaur_labyrinth/Sounds/metal_gong.wav")
    minotaur_spawn_sound.set_volume(1.0)
    
    player_death_sound = pygame.mixer.Sound("./minotaur_labyrinth/Sounds/player_death.wav")
    player_death_sound.set_volume(0.8)
    
    player_walking_sound = pygame.mixer.Sound("./minotaur_labyrinth/Sounds/player_walking.wav")
    player_walking_sound.set_volume(0.5)
    
    # The sound played when the player collects all four pieces of gear
    all_gear_sound = pygame.mixer.Sound("./minotaur_labyrinth/Sounds/player_full_gear.wav")
    all_gear_sound.set_volume(0.8)

    # Images
    
    game_over_message = pygame.image.load("./minotaur_labyrinth/MiscImages/Game_Over_Screen.jpg")
    
    vision_space = pygame.image.load("./minotaur_labyrinth/MiscImages/vision_limiter.png")
    vision_off = pygame.image.load("./minotaur_labyrinth/MiscImages/vision_limiter_off.png")

    player = minotaur_labyrinth.labyrinthSprites.Player(screen, maze_arrangement)
    minotaur = minotaur_labyrinth.labyrinthSprites.Minotaur(screen, maze_arrangement)
    visible_area = minotaur_labyrinth.labyrinthSprites.VisionLimiter(screen, vision_space)
    visible_off = minotaur_labyrinth.labyrinthSprites.NoVisionLimiter(screen, vision_off)
    ...
    health_tracker = minotaur_labyrinth.labyrinthSprites.HealthKeeper(screen)
    gear_tracker = minotaur_labyrinth.labyrinthSprites.GearTracker()
    countdown = minotaur_labyrinth.labyrinthSprites.Countdown()
...
def save_user_name(screen):
    # DISPLAY ==================================================================
    background = pygame.image.load("./minotaur_labyrinth/MiscImages/Player_Name_Screen.jpg")
    screen.blit(background, (0, 0))    
    ...
    survivor_font = pygame.font.Font("./minotaur_labyrinth/Fonts/PressStart2P.ttf", 18)
